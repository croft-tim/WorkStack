        ...
        <div className="flex items-center gap-4">
          ...
          {!user ? (
            <button
              ...
              className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800 pink:border-pink-300 pink:text-pink-800 pink:hover:bg-pink-100"
            >
              Login
            </button>
          ) : (

    ...
    <div className="flex h-screen flex-col bg-zinc-950 font-sans text-zinc-100">
      ...
      <header className="flex h-16 shrink-0 items-center justify-between border-b border-zinc-900 bg-zinc-950 px-8">
        <div className="flex items-center gap-4">
          <Link
            to="/"
            className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500 font-bold text-zinc-950 transition-all hover:bg-amber-400"
          >
            T
          </Link>
          <h1 className="text-lg font-bold tracking-tight">TradieFlow</h1>
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-64 rounded-lg border border-zinc-800 bg-zinc-900/50 py-2 pl-10 pr-4 text-xs transition-colors focus:border-amber-500/50 focus:outline-none"
            />
          </div>

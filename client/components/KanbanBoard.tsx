...
export default function KanbanBoard() {
  ...
  return (
    <div className="flex h-full flex-col font-sans transition-colors duration-300 bg-white dark:bg-zinc-950 pink:bg-pink-50 text-zinc-900 dark:text-zinc-100 pink:text-pink-900">
      {/* Board Content */}
